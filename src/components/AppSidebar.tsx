...
import { LayoutDashboard, Inbox, Settings, GaugeCircle, FlaskConical, ChevronLeft, ChevronRight, ShieldCheck, History, Library, BrainCircuit } from "lucide-react";
...
const nav = [
  ...
  { to: "/modelos", label: "Modelos", icon: BrainCircuit },
